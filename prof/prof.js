...
// 	]
	...
	let big = [
		['Маляр','https://i.ibb.co/ZcmWFsy/malar.png','comfort'/*,'display="none"'*/],
		['Электромонтер по ремонту и обслуживанию электрооборудования','https://i.ibb.co/0Yp3TnW/electromon.jpg','comfort'],
		['Слесарь-сантехник','https://i.ibb.co/GJSvV87/slesar.jpg','comfort'],
		['Портной','https://i.ibb.co/bFxHjLR/portnoi.jpg','creative'],
		['Токарь-универсал','https://i.ibb.co/7NPYq5g/tokar.jpg','industrial'],
		['Штукатур','https://i.ibb.co/yprGS6s/shtukatur.jpg','comfort'],
		['Плотник','https://i.ibb.co/fxHhST2/plotnik.jpg','comfort'],
		['Сварщик','https://i.ibb.co/L9VVJ57/svarshik.jpg','comfort'],
		['Оператор БПЛА','https://i.ibb.co/k8B9P7n/bpla.jpg','industrial'],
		['Гид (экскурсовод)','https://i.ibb.co/tXwGh1Y/gid.jpg','social'],
		['Психолог','https://i.ibb.co/ZHNW52X/psiho.jpg','social'],
		['Менеджер по туризму','https://i.ibb.co/h1ZKG1j/turmanager.jpg','social'],
	   ['Официант','https://i.ibb.co/x7T4WM9/oficiant.jpg','social'],
	   ...
	   ['Предприниматель малого бизнеса','https://i.ibb.co/1rncdsD/maliy-bus.jpg','business'],
	   ['Юрист','https://i.ibb.co/s2LQfvS/lawyer.jpg','business'],
	   ['Мастер по ремонту и обслуживанию автомобилей','https://i.ibb.co/KjssDDQ/avtomaster.jpg','industrial'],
	   ['Фронтенд-разработчик','https://i.ibb.co/12vQ6Ry/frontend.jpg','smart'],
	   ['Менеджер по качеству','https://i.ibb.co/SKrb1N0/catchmanager.jpg','industrial'],
	   ['Разработчик Web и мультимедийных приложений','https://i.ibb.co/8mms07k/vebmobile.jpg','smart'],
	   ['Фармацевт','https://i.ibb.co/8sg5fPc/farmacevt.jpg','heal'],
	   ['Фармаколог','https://i.ibb.co/Rctx2rc/farmacolog.jpg','heal'],
	   ['Эколог','https://i.ibb.co/b21rn1j/ecolog.jpg','heal'],
	   ['Почвовед','https://i.ibb.co/W0DdfNB/pochvoved.jpg','agrar'],
	   ['Специалист по экологической безопасности','https://i.ibb.co/xq7hv5V/ecoprotect.jpg','heal'],
	   ['Лаборант химического анализа','https://i.ibb.co/kDSHrcN/laborant.jpg','industrial'],
	   ['Лаборант по контролю качества сырья, реактивов, промежуточных продуктов, готовой продукции, отходов производства','https://i.ibb.co/ZWD1nVT/laborant-control.jpg','industrial'],
	   ['Инженер по охране окружающей среды','https://i.ibb.co/1KJy1FP/engineer-wild.jpg','heal'],
	   ['Инженер-электрик','https://i.ibb.co/5KBMcMv/engineer-electro.jpg','industrial'],
	   ['Технолог продуктов общественного питания массового изготовления и специализированных пищевых продуктов','https://i.ibb.co/pXy8Jhc/tehnopit.jpg','agrar'],
	   ['Специалист по информационным кабельным сетям','https://i.ibb.co/dPKms1t/cabel.jpg','secure'],
	   ['Специалист по информационной безопасности','https://i.ibb.co/MpM7VGD/infosecure.jpg','secure'],
	   ['Бэкенд-разработчик','https://i.ibb.co/n62MX25/backend.jpg','smart'],
	   ['Гейм-дизайнер','https://i.ibb.co/SfrQHgP/gamedesigner.jpg','smart'],
	   ['Дизайнер виртуальных миров','https://i.ibb.co/njL2b5R/virtual-designer.png','smart'],
	   ['Инженер по 3D печати','https://i.ibb.co/K08sd5R/3dprint.jpg','comfort'],
	   ['Электрохимик','https://i.ibb.co/sq7qx3d/electrohim.jpg','industrial'],
   ]
