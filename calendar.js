...
function CalendarControl() {
    ...
    const calendarControl = {
      ...
      plotSelectors: function () {
        document.querySelector(
          ...
          <div class="calendar-prev"><a class="switchMonth"><svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" viewBox="0 0 128 128"><path fill="#666" d="M88.2 3.8L35.8 56.23 28 64l7.8 7.78 52.4 52.4 9.78-7.76L45.58 64l52.4-52.4z"/></svg></a></div>
          <div class="calendar-year-month">
          <div class="calendar-month-label"></div>
          <div>-</div>
          <div class="calendar-year-label"></div>
          </div>
          <div class="calendar-next"><a class="switchMonth"><svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" viewBox="0 0 128 128"><path fill="#666" d="M38.8 124.2l52.4-52.42L99 64l-7.77-7.78-52.4-52.4-9.8 7.77L81.44 64 29 116.42z"/></svg></a></div>
          </div>
          <div class="calendar-today-date">Сегодня:
            ${calendarControl.calWeekDays[calendarControl.localDate.getDay()]}, 
            ${calendarControl.localDate.getDate()}, 
            ${calendarControl.calMonthName[calendarControl.localDate.getMonth()]} 
            ${calendarControl.localDate.getFullYear()} (Все мероприятия)
          </div>
  ...
  let datas = document.querySelectorAll(".number-item");
  let month;
  let year;
  let newinfo = document.getElementsByClassName('n_block');


  document.querySelectorAll('.switchMonth').forEach(
    (strelka)=>{
...
function fordatas(){
    datas.forEach(element => { 
        ...
        element.addEventListener('click',()=>{
            ...
            if(document.querySelector('.calendar-today')!= null){
                document.querySelector('.calendar-today').onclick = function(){
                  for(let i = 0; i<newinfo.length;i++){
                    newinfo[i].style.display = "block";
                    }
             }   
              }
            ...
            news.forEach(element2=>{ 
              ...
              // }
                ...
                (element2[1].slice(-1) == year.innerText.slice(-1)))
                {   
                    for(let i = 0; i<newinfo.length;i++){
                    newinfo[i].style.display = "block";
                }
                    ...
                    for(let i = 0; i<newinfo.length;i++){
                        ...
                        if(document.querySelectorAll('.n_date')[i].innerText != element2[1]){
                            newinfo[i].style.display = "none";
                        }
